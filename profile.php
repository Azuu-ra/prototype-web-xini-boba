...
<head>
    ...
    <style>
        .avatar-circle{width:96px;height:96px;border-radius:999px;object-fit:cover;border:4px solid rgba(255,255,255,0.25);box-shadow:0 10px 24px rgba(0,0,0,0.08);} 
        .profile-card{border:0;border-radius:20px;box-shadow:0 10px 24px rgba(0,0,0,0.08);overflow:hidden;}
        .profile-header{color:#fff;}
        ...
        <div class="profile-header p-4 user-theme-gradient">
            <div class="d-flex align-items-center gap-3 flex-wrap">
                ...
                <div>
                    ...
                    <div class="small opacity-75">@<?php echo htmlspecialchars($user['username'] ?? 'user'); ?></div>
                    <div class="small opacity-75">Poin Anda: <b><?php echo (int)($user['poin'] ?? 0); ?></b></div>
                </div>
            </div>
        </div>
